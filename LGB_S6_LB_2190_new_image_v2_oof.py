...
#                    "gpu_device_id":-1,
                    ...
                    "metric": "rmse",
                   # "max_depth": 15,
                    "num_leaves": 250, # 500, 280,360,500,32
            ...
            lgsub.to_csv("qh_lgb_subv2_{}.csv".format(numIter),index=True,header=True)
...
val_predicts.to_csv('qh_lgb_train_v2_oof.csv', index=False)
...
"""
1w
mean rmse is: 0.23799876956454108
time costs:157.43955302238464

mean rmse is: 0.23809627841804093
time costs:140.71962809562683

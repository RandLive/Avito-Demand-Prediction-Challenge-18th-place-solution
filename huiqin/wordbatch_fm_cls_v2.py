...
if __name__ == '__main__':
    ...
    with timer("Stacking Features"):
        ...
        del train_word_features, train_char_features,train_title_word_features
        ...
        del test_word_features, tst_str_array, test_char_features,test_title_word_features
        gc.collect()
    ...
    with timer("Scoring FM FTRL"):
        clf = FM_FTRL(
            ...
            D_fm=200, e_noise=0.0, iters=5,
            inv_link="identity", e_clip=1.0, threads=1, use_avx=1, verbose=1
        )
    ...
    sub.to_csv('subm/wordbatch_fmtrl_submission.csv', index=False)


'''
FINAL RMSE 0.22265821448778575

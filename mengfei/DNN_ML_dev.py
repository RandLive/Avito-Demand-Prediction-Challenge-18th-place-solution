...
#mean train rmse:  0.2072044233726546
#mean valid rmse:  0.2536748896990903
#    tfidf_para2 = {
#        "stop_words": russian_stop,
#        "analyzer": "char",
#        "token_pattern": r"\w{1,}",
...
#    x = Dropout(0.05)(x)      
    ...
    model = Model([sparse_data, region, city, category_name, parent_category_name,
...
'''
5 folds (10 k):
mean train rmse:  0.23181004446117415
mean valid rmse:  0.24777537272491434  

mean valid rmse:  0.23837958088288805 (lgb)

5 folds (100 k):
mean train rmse:  0.22518858203631403
mean valid rmse:  0.23774227076947635  

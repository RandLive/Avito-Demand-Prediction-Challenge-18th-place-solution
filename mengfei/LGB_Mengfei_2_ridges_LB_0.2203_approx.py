...
# optimize ram usage
full_df["avg_days_up_user"] = full_df["avg_days_up_user"].astype('float32')
full_df["avg_times_up_user"] = full_df["avg_times_up_user"].astype('float32')
full_df["population"] = full_df["population"].astype('float32')
full_df["price_vs_income"] = full_df["price_vs_income"].astype('float32')
full_df["num_desc_punct"] = full_df["num_desc_punct"].astype('int32')
full_df["num_desc_capE"] = full_df["num_desc_capE"].astype('int32')
full_df["num_desc_capP"] = full_df["num_desc_capP"].astype('int32')
full_df["num_title_punct"] = full_df["num_title_punct"].astype('int32')
full_df["num_title_capE"] = full_df["num_title_capE"].astype('int32')
full_df["num_title_capP"] = full_df["num_title_capP"].astype('int32')
full_df["text_feature_2_words_vs_unique"] = full_df["text_feature_2_words_vs_unique"].astype('float32')
full_df["description_words_vs_unique"] = full_df["description_words_vs_unique"].astype('float32')
full_df["median_deal_probability_item_seq_number+"] = full_df["median_deal_probability_item_seq_number+"].astype('float32')
full_df["median_deal_probability_param_2"] = full_df["median_deal_probability_param_2"].astype('float32')
full_df["count_user_id_city"] = full_df["count_user_id_city"].astype('float32')
full_df["count_user_id_city_vs_population"] = full_df["count_user_id_city_vs_population"].astype('float32')
full_df["title_words_vs_unique"] = full_df["title_words_vs_unique"].astype('float32')
full_df["median_deal_probability_price+"] = full_df["median_deal_probability_price+"].astype('float32')
full_df["ridge_preds_1"] = full_df["ridge_preds_1"].astype('float32')
full_df["ridge_preds_2"] = full_df["ridge_preds_2"].astype('float32')
gc.collect()
...
#X = joblib.load("X.pkl")
#y = joblib.load("y.pkl")
#joblib = joblib.load("tfvocab.pkl")

...
if debug == False:
    ...
    train_df = pd.read_csv("../input/train.csv", parse_dates = ["activation_date"])
    train_df = shuffle(train_df, random_state=1234); train_df = train_df.iloc[:1000000]
    y = train_df["deal_probability"]
...
def feature_engineering(df):
    ...
    def Do_Label_Enc(df):
        ...
        lbl = LabelEncoder()
        cat_col = ["param_2",'user_id',"region", "city", "parent_category_name",
               "category_name", "user_type", "image_top_1",
               "param_1",  "param_3","image"
               ]
        for col in cat_col:
#            tmp_df = df[[col, 'item_id']]
#            na_free = tmp_df.dropna()            
#            tmp_df = df[col]
#            only_na = tmp_df[~tmp_df.index.isin(na_free.index)]
#            na_free[col] = lbl.fit_transform(na_free[col].astype(str))
            df[col] = df[col].fillna('beijing', inplace=True)
#            tmp_df[col] = lbl.fit_transform(tmp_df[col].astype(str))
#            df.drop([col], axis=1, inplace=True)
#            df = df.merge(tmp_df, on='item_id', how='left')
#            frame = [df, na_free, only_na]
#            df = pd.concat(frame)

#            tmp_df.dropna()
#            tmp_df.fillna('beijing', inplace=True)
            df[col] = lbl.fit_transform(df[col].astype(str))
#            df.reshape(-1,1)
#            tmp_df = pd.DataFrame(tmp_df)
#            mapping = dict(zip(lbl.classes_, range(len(lbl.classes_))))
            try:
                le_value = lbl.transform(['beijing'])           
                df[col].apply(lambda x: np.nan if x == le_value else x)
            except:
                pass
...
#       'image_top_1', 'param_2', 'param_3', 
        tmp_df = df[["param_2", "city", "parent_category_name", "user_type",
               "category_name", "user_type", "image_top_1",
               "param_1",  "param_3","image"]]
...
#        cols = ["image_top_1", "param_1", "param_2", "param_3", 'param_1', 'category_name', 'parent_category_name','user_type']
        tmp_df = pd.DataFrame(data=MICE().complete(tmp_df), columns=tmp_df.columns, index=tmp_df.index)
#        tmp_df[cols].apply(pd.to_numeric, errors='coerce', axis=1)
        df.drop([ "param_2", "city", "parent_category_name", "user_type",
               "category_name", "user_type", "image_top_1",
               "param_1",  "param_3","image"], axis=1, inplace=True)
        df.join(tmp_df)
...
"""
[100]   train's rmse: 0.224428  valid's rmse: 0.226792
[200]   train's rmse: 0.215798  valid's rmse: 0.220789
[300]   train's rmse: 0.211506  valid's rmse: 0.21878
[400]   train's rmse: 0.207884  valid's rmse: 0.217519
[500]   train's rmse: 0.20487   valid's rmse: 0.216687
[600]   train's rmse: 0.202304  valid's rmse: 0.216122
[700]   train's rmse: 0.200002  valid's rmse: 0.215762
[800]   train's rmse: 0.197806  valid's rmse: 0.215462
[900]   train's rmse: 0.195838  valid's rmse: 0.215215
[1000]  train's rmse: 0.193984  valid's rmse: 0.215029
[1100]  train's rmse: 0.192155  valid's rmse: 0.214889
[1200]  train's rmse: 0.190478  valid's rmse: 0.214758
[1300]  train's rmse: 0.1889    valid's rmse: 0.214671
[1400]  train's rmse: 0.18744   valid's rmse: 0.214615
[1500]  train's rmse: 0.186029  valid's rmse: 0.214557
[1600]  train's rmse: 0.184676  valid's rmse: 0.214505
[1700]  train's rmse: 0.183377  valid's rmse: 0.214462
[1800]  train's rmse: 0.182102  valid's rmse: 0.214406
[1900]  train's rmse: 0.180929  valid's rmse: 0.214362
[2000]  train's rmse: 0.179774  valid's rmse: 0.214339
[2100]  train's rmse: 0.178649  valid's rmse: 0.214305
[2200]  train's rmse: 0.177544  valid's rmse: 0.214289
[2300]  train's rmse: 0.176461  valid's rmse: 0.214278
[2400]  train's rmse: 0.175418  valid's rmse: 0.214261
[2500]  train's rmse: 0.174459  valid's rmse: 0.214256
[2600]  train's rmse: 0.173469  valid's rmse: 0.21425
[2700]  train's rmse: 0.172577  valid's rmse: 0.214245
[2800]  train's rmse: 0.17162   valid's rmse: 0.214234
[2900]  train's rmse: 0.170735  valid's rmse: 0.214233
[3000]  train's rmse: 0.1698    valid's rmse: 0.214224
[3100]  train's rmse: 0.168918  valid's rmse: 0.214219
[3200]  train's rmse: 0.168014  valid's rmse: 0.21422
[3300]  train's rmse: 0.167128  valid's rmse: 0.214202
[3400]  train's rmse: 0.166293  valid's rmse: 0.214189
[3500]  train's rmse: 0.165421  valid's rmse: 0.214197
[3600]  train's rmse: 0.164655  valid's rmse: 0.214196
Early stopping, best iteration is:
[3400]  train's rmse: 0.166293  valid's rmse: 0.214189
save model ...
Model Evaluation Stage
calculating RMSE ...
RMSE: 0.21418854801725937
...
[100]   train's rmse: 0.223988  valid's rmse: 0.226102
[200]   train's rmse: 0.2154    valid's rmse: 0.220184
[300]   train's rmse: 0.211005  valid's rmse: 0.218106
[400]   train's rmse: 0.207457  valid's rmse: 0.216893
[500]   train's rmse: 0.204595  valid's rmse: 0.216163
[600]   train's rmse: 0.202044  valid's rmse: 0.215627
[700]   train's rmse: 0.199692  valid's rmse: 0.215194
[800]   train's rmse: 0.197464  valid's rmse: 0.214841
[900]   train's rmse: 0.195476  valid's rmse: 0.214617
[1000]  train's rmse: 0.193665  valid's rmse: 0.214432
[1100]  train's rmse: 0.191932  valid's rmse: 0.214302
[1200]  train's rmse: 0.190274  valid's rmse: 0.214212
[1300]  train's rmse: 0.18869   valid's rmse: 0.214124
[1400]  train's rmse: 0.187163  valid's rmse: 0.214052
[1500]  train's rmse: 0.185673  valid's rmse: 0.213996
[1600]  train's rmse: 0.184296  valid's rmse: 0.213941
[1700]  train's rmse: 0.182958  valid's rmse: 0.213891
[1800]  train's rmse: 0.181765  valid's rmse: 0.213853
[1900]  train's rmse: 0.180548  valid's rmse: 0.213837
[2000]  train's rmse: 0.179463  valid's rmse: 0.213831
[2100]  train's rmse: 0.178348  valid's rmse: 0.213803
[2200]  train's rmse: 0.177229  valid's rmse: 0.213782
[2300]  train's rmse: 0.176163  valid's rmse: 0.213761
[2400]  train's rmse: 0.175127  valid's rmse: 0.213756
[2500]  train's rmse: 0.174101  valid's rmse: 0.213749
[2600]  train's rmse: 0.173128  valid's rmse: 0.213735
[2700]  train's rmse: 0.17221   valid's rmse: 0.213727
[2800]  train's rmse: 0.171314  valid's rmse: 0.213733
[2900]  train's rmse: 0.170355  valid's rmse: 0.213731
Early stopping, best iteration is:
[2703]  train's rmse: 0.17218   valid's rmse: 0.213725
save model ...
Model Evaluation Stage
calculating RMSE ...
RMSE: 0.21372519447322247
calculating RMSE ...
training in fold 3
training in fold 4
training in fold 5
...
training in fold 9
training in fold 10
mean rmse is: 0.21395687124524093
Features importance...
                               feature       gain  split
85                       ridge_preds_2  17.958647  16150
30                         image_top_1  10.898074  81090
34                             param_1   5.890004  30633
25                                city   4.803033  59826
24                       category_name   3.255440  15469
84                       ridge_preds_1   3.148422  14827
37                parent_category_name   2.318976   3457
35                             param_2   1.980385  17604
39                               price   1.937168  17019
82                              price+   1.609452  15270
40                              region   1.592268  31749
33                        n_user_items   1.436927  10436
36                             param_3   1.233273  14175
21                    avg_days_up_user   0.879449  12438
41                             user_id   0.867237  10762
32                     item_seq_number   0.670874  14705
38                          population   0.662152  13377
5                       average_LAB_As   0.635202  12244
22                   avg_times_up_user   0.553706   8931
72     text_feature_2_num_unique_words   0.489579   1112
67              text_feature_num_words   0.481459   1789
45                      num_desc_punct   0.439655   7755
23                         blurinesses   0.399017  13349
66              text_feature_num_chars   0.392071   5856
74               description_num_chars   0.390821  11952
83                    item_seq_number+   0.388604   5080
70            text_feature_2_num_chars   0.377670   2628
12                   average_YCrCb_Crs   0.371834  10279
3                       average_HSV_Ss   0.369963  11720
9                       average_LUV_Us   0.349212  10518
13                    average_YCrCb_Ys   0.337191   8444
19                 average_pixel_width   0.335313  12697
2                       average_HLS_Ss   0.332610  11784
17                       average_blues   0.328911  10697
75               description_num_words   0.326765   8229
78                     title_num_chars   0.322938  10490
14                      average_YUV_Us   0.322504  11056
20                        average_reds   0.317740  10296
0                       average_HLS_Hs   0.305507  11458
42                           user_type   0.296103   2100
15                      average_YUV_Vs   0.289890   9726
16                      average_YUV_Ys   0.289714   8761
29                       image_quality   0.289609  11706
4                       average_HSV_Vs   0.285811   9736
18                      average_greens   0.284486   8620
33355           description__состоянии   0.279360   4377
76        description_num_unique_words   0.279224   8389
6                       average_LAB_Bs   0.278386   9394
1                       average_HLS_Ls   0.278058   9066
10                      average_LUV_Vs   0.270154   9577
All Done.

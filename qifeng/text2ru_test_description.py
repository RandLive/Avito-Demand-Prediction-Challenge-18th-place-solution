...
#    train_data = pd.read_csv(args.train_file_path)
    comments_list = test_df["description"].fillna(NAN_WORD).values
    ...
    for language in args.languages:
        ...
        test_df["description_ru"] = translated_data

        result_path = os.path.join(args.result_path, "test_description_" + language + ".csv")

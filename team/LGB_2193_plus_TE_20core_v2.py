...
for train_index, valid_index in kf2.split(y):
      ...
      if numIter>=numLimit+1:
            ...
            print("load yuki oof  ...")
            yuki_oof_train = pd.read_csv('../input/lgb_oof_yuki_train_1.csv')
            yuki_oof_train.drop("user_id", axis=1, inplace=True)
            yuki_oof_test = pd.read_csv('../input/lgb_oof_yuki_test_1.csv')
            ...
            yuki_oof_full["yuki_oof"] = yuki_oof_full["deal_probability"]
            del yuki_oof_full["deal_probability"]

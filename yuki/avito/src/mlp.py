...
output_labels = ["oof_stacking_level1_mlp_2_{}_{}".format(arch,loss_function)]
...
to_parquet(df_oof_val,"../features/oof_stacking_level1_mlp_2_{}_{}_train.parquet".format(arch,loss_function))
to_parquet(df_oof_test, "../features/oof_stacking_level1_mlp_2_{}_{}_test.parquet".format(arch,loss_function))
